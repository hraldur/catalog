...
def categoryList(category_id):
    ...
    if 'username' not in login_session:
        return render_template('category-public.html', category = category,
    ...
    # Check is logged in user is the owner
        ...
        return render_template('category-owner.html', category = category,
                                category_id = category_id, items = items,
                                categories = categories,
                                username = login_session['username'])
...
def itemDescription(category_id, item_id):
    ...
    if 'username' not in login_session:
        return render_template('item-public.html',  category_id = category_id,
...
def editItem(category_id, item_id):
    ...
    if request.method == 'POST':
        ...
        session.commit()
        flash("Item edited.")
        return redirect(url_for('itemDescription', category_id = category_id,
...
def deleteItem(category_id, item_id):
    ...
    if request.method == 'POST':
        ...
        return render_template('delete.html', category_id = category_id,
                                item_id = item_id, categories = categories,
                                username = login_session['username'])
